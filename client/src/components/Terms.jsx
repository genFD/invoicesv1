...
const selectedStyles =
  "w-full py-4 px-3 rounded text-body-1 text-5F6FAB dark:text-FFFF font-bold dark:text-FFFF focus:outline-none dark:bg-252945 dark:border-252945 focus:border-9277FF caret-9277FF";
